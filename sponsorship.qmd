...
-   If requested, company/ organization information session on Duke campus advertised to Duke StatSci students as well as all 2025 ASA DataFest<small><sup>TM</sup></small> participants. The information session is not concurrent with the DataFest event, but booked at a separate time.
...
Please do not hesitate to contact [Alexander Fisher](mailto:alexander.fisher@duke.edu), ASA DataFest<small><sup>TM</sup></small> \@ Duke coordinator, with any questions. We will work with you to find the package that best meets your organization’s goals.
